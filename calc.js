...
function calc() {
  ...
  switch (document.getElementById('route').value) {
    ...
    case 'Nose':
      ...
      switch (document.getElementById('noseDrugs').value) {
        case 'ipra3':
          ...
          break;
        case 'ryaltris':
          proof = "("+document.getElementById('NosePkg').value+" pkg x 240 sprays/pkg)";
          totalSprays = document.getElementById('NosePkg').value*240;
          break;
        case 'azelastine':
          proof = "("+document.getElementById('NosePkg').value+" pkg x 200 sprays/pkg)";
          totalSprays = document.getElementById('NosePkg').value*200;
          break;
        case 'ipra6':
        ...
        case 'omnaris':
          ...
          break;
        case 'zetonna':
          proof = "("+document.getElementById('NosePkg').value+" pkg x 60 sprays/pkg)";
          totalSprays = document.getElementById('NosePkg').value*60;
          break;
        case 'desmopressin':
          proof = "("+document.getElementById('NosePkg').value+" pkg x 50 sprays/pkg)";
          totalSprays = document.getElementById('NosePkg').value*50;
          break;
        case 'calcitonin':
          proof = "("+document.getElementById('NosePkg').value+" pkg x 30 sprays/pkg)";
          totalSprays = document.getElementById('NosePkg').value*30;
          break;
        case 'butorphanol':
          proof = "("+document.getElementById('NosePkg').value+" pkg x 14 sprays/pkg)";
          totalSprays = document.getElementById('NosePkg').value*14;
          break;
      }
      // Validate inputs and calculate days supply
    ...
    case 'Inj':
      ...
      let dailyUnits;
      let totalDailyUnits = document.getElementById('injIU').value;
      // Calculate total daily dose (pens only)
      switch (document.getElementById('injDrugs').value) {
        case 'u100pen':
        case 'u200pen':
          proof = proof+" / ("+totalDailyUnits+" units + ("+document.getElementById('injFreq').value+" injections x 2 priming units)) =";
          dailyUnits = Number(totalDailyUnits)+(document.getElementById('injFreq').value*2);
          ...
          break;
        case 'toujeo':
          proof = proof+" / ("+totalDailyUnits+" units + ("+document.getElementById('injFreq').value+" injections x 3 priming units)) =";
          dailyUnits = Number(totalDailyUnits)+(document.getElementById('injFreq').value*3);
          notes = "Check room temperature stability of drug if over 56 days supply";
          break;
        case 'toujeomax':
          proof = proof+" / ("+totalDailyUnits+" units + ("+document.getElementById('injFreq').value+" injections x 4 priming units)) =";
          dailyUnits = Number(totalDailyUnits)+(document.getElementById('injFreq').value*4);
          notes = "Check room temperature stability of drug if over 56 days supply";
          break;
        case 'u500pen':
          proof = proof+" / ("+totalDailyUnits+" units + ("+document.getElementById('injFreq').value+" injections x 5 priming units)) =";
          dailyUnits = Number(totalDailyUnits)+(document.getElementById('injFreq').value*5);
